var whatTime = Math.floor((Math.random() * 10000) + 10000);
...
function randomwhat() {	
    what.textContent = whatlist[Math.floor(Math.random() * whatlist.length)];
...
function init() {
    ...
    startButton.onclick = function() {
        randomwhat();
        var whatTime = Math.floor((Math.random() * 6000) + 6000);
